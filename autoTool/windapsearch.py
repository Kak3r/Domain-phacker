...
def run(args):
	...
	if args.groups:
		...
		if True:
			filename = "groups.tsv".format(args.output_dir)
	...
	if args.users:
		...
		if True:
			filename = "users.tsv".format(args.output_dir)
	...
	if args.computers:
		...
		if True:
			filename = "computers.tsv".format(args.output_dir)
	...
	if args.da:
		...
		if True:
			filename = "domainadmins.tsv".format(args.output_dir)
	...
	if args.lookup:
		...
		if True:
			filename = "lookup.tsv".format(args.output_dir)
